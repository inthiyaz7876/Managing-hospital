...
function TodayOP() {
  const labData = [
    ...
    {
      PatientName: 'Varan Kaloi',
      Address: 'KR Pura',
      Date: '7-7-2023',
      Problem: 'Hand facture',
      Age: 46,
      Gender: 'Male',
      AssigneDoctor: 'Molwell',
    },
    {
      PatientName: 'Thonu Mal',
      Address: 'Batrahalli',
      Date: '7-7-2023',
      Problem: 'Fever',
      Age: 34,
      Gender: 'Male',
      AssigneDoctor: 'Looper',
    },
    {
      PatientName: 'Kareon',
      Address: 'Ayyappa nagar',
      Date: '7-7-2023',
      Problem: 'Surgery',
      Age: 45,
      Gender: 'Male',
    ...
    {
      PatientName: 'Shivakar',
      Address: 'Maratha halli',
      Date: '7-7-2023',
      Problem: 'General',
      Age: 35,
      Gender: 'Male',
  ...
  const opModal = (data) => {
    return (
      <>
        ...
        <div className="op_form">
          <Button value={'info'} onClick={() => saveOP()}>
            Save OP
          </Button>
        </div>
      </>
        ...
        <tbody>
          {labData.map((item, index) => (
            <tr>
              ...
              <td>
                <Button onClick={(e) => editOP(e, item)}>Edit</Button>
              </td>
            </tr>
          ))}
        </tbody>
